 CREATE TABLE IF NOT EXISTS `project-1bb5b715-2af0-445a-b7a.silver_dataset.departments` (
    dept_id STRING,
    name STRING,
...
TRUNCATE TABLE `project-1bb5b715-2af0-445a-b7a.silver_dataset.departments`;

-- 3. full load 
INSERT INTO `project-1bb5b715-2af0-445a-b7a.silver_dataset.departments`
SELECT DISTINCT 
    deptid,
    name,
    CASE 
...
FROM (
    SELECT DISTINCT *  FROM `project-1bb5b715-2af0-445a-b7a.bronze_dataset.departments`
);

-------------------------------------------------------------------------------------------------------

-- 1. Create table providers 
CREATE TABLE IF NOT EXISTS `project-1bb5b715-2af0-445a-b7a.silver_dataset.providers` (
    ProviderID STRING,
    FirstName STRING,
    LastName STRING,
...
-- 2. Truncate Silver Table Before Inserting 
TRUNCATE TABLE `project-1bb5b715-2af0-445a-b7a.silver_dataset.providers`;

-- 3. full load 
INSERT INTO `project-1bb5b715-2af0-445a-b7a.silver_dataset.providers`
SELECT DISTINCT 
    ProviderID,
    FirstName,
    LastName,
    ...
    END AS is_quarantined
FROM (
    SELECT DISTINCT * FROM `project-1bb5b715-2af0-445a-b7a.bronze_dataset.providers`
 );
...
--------------------------------------------------
-- encounters table
CREATE TABLE IF NOT EXISTS `project-1bb5b715-2af0-445a-b7a.silver_dataset.encounters` (
  EncounterID STRING,
  PatientID STRING,
  EncounterDate DATE,
...
TRUNCATE TABLE `project-1bb5b715-2af0-445a-b7a.silver_dataset.encounters`;
INSERT INTO `project-1bb5b715-2af0-445a-b7a.silver_dataset.encounters`
SELECT DISTINCT 
  EncounterID,
  PatientID,
  ...
  END AS is_quarantined
FROM (
  SELECT DISTINCT * FROM `project-1bb5b715-2af0-445a-b7a.bronze_dataset.encounters`
);

--------------------------------------
CREATE TABLE IF NOT EXISTS `project-1bb5b715-2af0-445a-b7a.silver_dataset.transactions` (
...
TRUNCATE TABLE `project-1bb5b715-2af0-445a-b7a.silver_dataset.transactions`;
INSERT INTO `project-1bb5b715-2af0-445a-b7a.silver_dataset.transactions`
SELECT DISTINCT 
  TransactionID,
  EncounterID,
  PatientID,
  ...
  END AS is_quarantined
FROM (
  SELECT DISTINCT * FROM `project-1bb5b715-2af0-445a-b7a.bronze_dataset.transactions`
);

-----------------------------
-- 1. Create 
CREATE TABLE IF NOT EXISTS
`project-1bb5b715-2af0-445a-b7a.silver_dataset.claims` (
    claim_id STRING,
...
SELECT
    ...
    END AS is_quarantined
FROM
    `project-1bb5b715-2af0-445a-b7a.bronze_dataset.claims` t1;
